from app import app, db, Animal, Habitat, VetRecord, User
...
#     # Ajoute des utilisateurs avec des rôles spécifiques
#     user1 = User(id=1, username="admin", password="adminpassword", role="admin")
#     user2 = User(id=2, username="employee", password="employeepassword", role="employee")
#     user3 = User(id=3, username="veterinarian", password="veterinarianpassword", role="veterinarian")
